...
$c = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($a, $b, new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, ($this->privates['cache.property_access'] ?? $this->load('getCache_PropertyAccessService.php')), true), new \Symfony\Component\PropertyInfo\PropertyInfoCacheExtractor(new \Symfony\Component\PropertyInfo\PropertyInfoExtractor(new RewindableGenerator(function () {
...
}, 1)), ($this->privates['cache.property_info'] ?? $this->load('getCache_PropertyInfoService.php'))), new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($a), NULL, []);
