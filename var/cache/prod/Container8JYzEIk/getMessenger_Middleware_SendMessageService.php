...
$this->privates['messenger.middleware.send_message'] = $instance = new \Symfony\Component\Messenger\Middleware\SendMessageMiddleware(new \Symfony\Component\Messenger\Transport\Sender\SendersLocator(['App\\Message\\AddPonkaToImage' => [0 => 'async_priority_high'], 'App\\Message\\DeletePhotoFile' => [0 => 'async']], new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
