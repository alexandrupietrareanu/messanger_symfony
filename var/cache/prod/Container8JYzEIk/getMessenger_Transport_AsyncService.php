...
return $this->privates['messenger.transport.async'] = ($this->privates['messenger.transport_factory'] ?? $this->load('getMessenger_TransportFactoryService.php'))->createTransport($this->getEnv('MESSENGER_TRANSPORT_DSN'), [], ($this->privates['messenger.transport.native_php_serializer'] ?? ($this->privates['messenger.transport.native_php_serializer'] = new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer())));
