...
// Returns the private 'messenger.transport.failed' shared service.
...
return $this->privates['messenger.transport.failed'] = ($this->privates['messenger.transport_factory'] ?? $this->load('getMessenger_TransportFactoryService.php'))->createTransport('doctrine://default?queue_name=failed', [], ($this->privates['messenger.transport.native_php_serializer'] ?? ($this->privates['messenger.transport.native_php_serializer'] = new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer())));
