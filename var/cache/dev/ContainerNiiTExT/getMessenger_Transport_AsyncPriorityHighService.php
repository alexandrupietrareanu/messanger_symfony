...
return $this->privates['messenger.transport.async_priority_high'] = ($this->privates['messenger.transport_factory'] ?? $this->load('getMessenger_TransportFactoryService.php'))->createTransport('sync://', ['queue_name' => 'high'], ($this->privates['messenger.transport.native_php_serializer'] ?? ($this->privates['messenger.transport.native_php_serializer'] = new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer())));
